...
const Container: FunctionComponent<ContainerInterface> = styled('div')<{styleString?: any,}>`
    display: flex;
    flex-direction: row;
    flex-wrap: wrap;    
...
const Col: FunctionComponent<ColInterface> = styled('div')<{size: number, colSize?: number, styleString?: any,}>`
